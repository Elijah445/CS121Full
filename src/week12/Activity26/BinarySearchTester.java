...
import week12.Activity26.BinarySearchDemo;
...
public class BinarySearchTester {
    public static void main(String[] args) {
        ...
        ArrayList<Integer> array = new ArrayList<>(List.of(23, 17, 12, 90, 84, 38, 5, 77, 44));
    ...
    {
        ArrayList<Integer> sortedArray = new ArrayList<>(unsortedArray);
